<template>
  <aside class="sidebar d-flex flex-column justify-content-between">
    ...
    <!-- Bas : Paramètres -->
    <div class="rapport">
      <router-link to="/agent/parametre" class="menu-link" :class="{ actif: isActive('/agent/parametres') }" exact>
...
const menuItems = [
  { path: '/agent/biens', label: 'Biens immobiliers', icon: Home },
  { path: '/agent/proprietaires', label: 'Propriétaires', icon: User },
  { path: '/agent/reservations', label: 'Réservations', icon: Calendar },
  { path: '/agent/contrats', label: 'Contrats', icon: FileText },
  { path: '/agent/photos', label: 'Photos', icon: FileSignature },
  { path: '/agent/villes', label: 'Villes', icon: MapPin },
  { path: '/agent/types-bien', label: 'Types de bien', icon: Layers },
