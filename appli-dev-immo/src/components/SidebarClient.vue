<template>
  <aside class="sidebar d-flex flex-column justify-content-between">
    ...
    <!-- Bas : Paramètres -->
    <div class="rapport">
      <router-link to="/public" class="menu-link" :class="{ actif: isActive('/public') }" exact>
        <Home class="icondash" />
...
import { Home, List, Calendar, Bell, MessageCircle, Settings } from 'lucide-vue-next'

const route = useRoute()
const isActive = (path) => route.path === path

const menuItems = [
  { path: '/client/biens', label: 'Biens immobiliers', icon: List },
  { path: '/client/reservations', label: 'Réservations', icon: Calendar },
  // { path: '/client/notifications', label: 'Notifications', icon: Bell },
  // { path: '/client/messagerie', label: 'Messagerie', icon: MessageCircle }
]
</script>
